...
<template>
  <div class="bg-gray-100 min-h-screen flex flex-col">
    <div class="border-b-1 bg-white">
      <div class="container flex items-center justify-center md:justify-between mx-a p-2">
        <nuxt-link to="/"> 
        ...
        <div class="hidden md:flex gap-4">
          ...
          <div v-if="meta.phones?.length" class="flex gap-2 items-center">
            ...
            <i class="i-ic-phone text-2xl text-gray" />
          </div>
        </div>
      </div>
    </div>

    <main class="container flex-1 mx-a p-2">
      <NuxtPage />
      <div class="fixed bottom-12 right-5 animate-bounce rounded bg-white border">
        <Call>
          <i class="i-ic-phone text-6xl text-gray" />
        </Call>
      </div>
    </main>

    <div class="border-t-1 bg-white">
      <div class="container flex flex-col gap-4 p-2 items-center justify-center mx-a">
        <nuxt-link to="/"> 
          <img :src="meta.logo" alt="logo" class="h-24">
        </nuxt-link>
        <div v-if="meta.phones?.length" class="flex gap-2 items-center">
